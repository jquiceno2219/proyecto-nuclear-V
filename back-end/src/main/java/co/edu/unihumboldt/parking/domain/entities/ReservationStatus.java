...
/**
 * Clase {@code ReservationStatus} que representa el estado de una reserva en el sistema.
...
@Builder
@Entity
@Table(name = "reservations_status",schema = "public", indexes = @Index(columnList = "id"))
